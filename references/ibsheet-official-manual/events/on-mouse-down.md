...
KEY: onMouseDown
KIND: event
PATH: events/on-mouse-down
ALIAS: 시트에서, 마우스가, 눌려졌을때, 호출되는, 이벤트입니다
ALIAS_EN: on, mouse, down
SOURCE_URL: https://docs.ibsheet.com/ibsheet/v8/manual/#docs/events/on-mouse-down
---
# onMouseDown ***(event)***
