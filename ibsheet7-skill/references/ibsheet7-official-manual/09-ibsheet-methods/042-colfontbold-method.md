...
> **IBSheet7 개발자 가이드** > IBSheet Methods > ColFontBold Method

---

- **기능**

> 대상 컬럼 전체의 Bold(굵은 글자체)를 설정하거나 확인한다. 헤더 행을 제외한 데이터 행만 처리한다.
>
...
|        |     |                               |
|:------:|:---:|-------------------------------|
| Syntax | Get | ObjId.**GetColFontBold**(Col) |

- **Info**

> **Return**: Boolean, Bold 설정 값 (Get Method 인 경우)
...
|        |     |                                     |
|:------:|:---:|-------------------------------------|
| Syntax | Set | ObjId.**SetColFontBold**(Col, Bold) |
