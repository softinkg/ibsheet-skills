...
> **IBSheet7 개발자 가이드** > IBSheet Events > OnKeyUp Event

---

- **기능**

> 셀의 값을 수정 중이거나 선택된 셀에 눌린 키보드가 올라오는 경우 이벤트가 발생한다. 이 이벤트는 OnKeyDown 이벤트 발생 후에 바로 발생한다.
>
...
|        |                                                               |
|:------:|---------------------------------------------------------------|
| Syntax | **function 오브젝트ID_OnKeyUp**(Row, Col, KeyCode, Shift) { } |
