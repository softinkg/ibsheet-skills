...
PATH: props/col/mask-color
ALIAS: 속성, 설정시, 정규식에, 위배되는, 값이
ALIAS_EN: mask, color, property, attribute
SOURCE_URL: https://docs.ibsheet.com/ibsheet/v8/manual/#docs/props/col/mask-color
---
# !MaskColor ***(col)***
...
options.Cols = [
    ...
    {Type: "Text", EditMask: "^\\S*$", MaskColor: "#FFFF00", Name: "CN_Code",
     Width: 120 ...},
    ...
];
```
